...
const Navbar = () => {
  return (
    <nav className="max-w-[100vw] h-14 md:h-16 border-b px-3 md:px-4 flex justify-between items-center bg-white fixed left-0 right-0 top-0 z-50">
      <div className="flex flex-row items-center gap-2">
        ...
        <div className="ml-[26px] hidden lg:flex flex-row gap-2">
          ...
          <Button
            ...
            title="Hotels"
            className="text-[#202124] h-10 pl-3 pr-4 border-[#dadce0]"
            icon={<svg className="fill-[#1A73E8]" enableBackground="new 0 0 24 24" height="18" viewBox="0 0 24 24" width="18" focusable="false"><g><rect fill="none" height="24" width="24"></rect></g><g><g><path d="M7 14c1.66 0 3-1.34 3-3S8.66 8 7 8s-3 1.34-3 3 1.34 3 3 3zm12-7h-8v8H3V5H1v15h2v-3h18v3h2v-9c0-2.21-1.79-4-4-4z"></path></g></g></svg>}
          />
          <Button
            variant="outline"
            title="Vacation Rentals"
            className="text-[#202124] h-10 pl-3 pr-4 border-[#dadce0]"
            icon={<svg className="fill-[#1A73E8]" enableBackground="new 0 0 24 24" height="18" viewBox="0 0 24 24" width="18" focusable="false"><g><g><rect fill="none" height="24" width="24"></rect></g></g><g><g><g><path d="M19,9.3V4h-3v2.6L12,3L2,12h3v8h5v-6h4v6h5v-8h3L19,9.3z M10,10c0-1.1,0.9-2,2-2s2,0.9,2,2H10z"></path></g></g></g></svg>}
          />
        </div>
      </div>
      <div className="flex flex-row items-center gap-2.5">
        <button className="w-8 h-8 flex justify-center items-center rounded-full hover:bg-gray-100">
          <svg className="fill-[#5f6368]" enableBackground="new 0 0 24 24" height="18" viewBox="0 0 24 24" width="18" focusable="false"><rect fill="none" height="24" width="24"></rect><path d="M12,3c-4.97,0-9,4.03-9,9s4.03,9,9,9s9-4.03,9-9c0-0.46-0.04-0.92-0.1-1.36c-0.98,1.37-2.58,2.26-4.4,2.26 c-2.98,0-5.4-2.42-5.4-5.4c0-1.81,0.89-3.42,2.26-4.4C12.92,3.04,12.46,3,12,3L12,3z"></path></svg>
        </button>
        <button className="w-10 h-10 flex justify-center items-center rounded-full hover:bg-gray-100">
